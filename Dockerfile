...
WORKDIR /src
COPY ["YoutubeApiSyncronize/YoutubeApiSyncronize.csproj", "YoutubeApiSyncronize/"]
RUN dotnet restore "YoutubeApiSyncronize/YoutubeApiSyncronize.csproj"
COPY . .
WORKDIR "/src/YoutubeApiSyncronize"
