...
public class CategoryController : ControllerBase
{
    ...
    public async Task<ActionResult<List<Category>>> GetAllCategories()
    {
        ...
        {
            _logger.Error(ex, "Error in GetAllCategories endpoint");
    ...
    public async Task<ActionResult<CategoryResponse>> GetCategoryById(int id)
    {
        ...
        {
            _logger.Warning(ex, "Category not found with id: {Id}", id);
            return NotFound(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.Error(ex, "Error in GetCategoryById endpoint");
            return StatusCode(500, new { error = "Internal server error" });
        }
    }
    ...
    public async Task<ActionResult<List<MenuItemResponse>>> GetMenuItems()
    {
        ...
        {
            _logger.Error(ex, "Error in GetMenuItems endpoint");
            return StatusCode(500, new { error = "Internal server error" });
        }
    }
    ...
    public async Task<ActionResult<CategoryResponse>> CreateCategory([FromBody] CreateCategoryRequest request)
    {
        ...
        {
            _logger.Error(ex, "Error in CreateCategory endpoint");
            return StatusCode(500, new { error = "Internal server error" });
        }
    }
    ...
    public async Task<ActionResult<CategoryResponse>> UpdateCategory(int id, [FromBody] UpdateCategoryRequest request)
    {
        ...
        {
            _logger.Error(ex, "Error in UpdateCategory endpoint");
            return StatusCode(500, new { error = "Internal server error" });
        }
    }
    ...
    public async Task<IActionResult> DeleteCategory(int id)
    {
        ...
        {
            _logger.Error(ex, "Error in DeleteCategory endpoint");
            return StatusCode(500, new { error = "Internal server error" });
        }
    }
}
